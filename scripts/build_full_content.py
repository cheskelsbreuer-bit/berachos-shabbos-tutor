...
def main():
    masechtos = []
    print("=== GEMARA ===")
    masechtos.append(build_gemara_masechta("shabbos", "Shabbat", "Shabbos", "שבת", 2, 60))
    masechtos.append(build_gemara_masechta("berachos", "Berachos", "Berachos", "ברכות", 2, 35))
    masechtos.append(build_gemara_masechta("pesachim", "Pesachim", "Pesachim", "פּסחים", 2, 25))
    masechtos.append(build_gemara_masechta("sukkah", "Sukkah", "Sukkah", "סוכה", 2, 20))
    masechtos.append(build_gemara_masechta("megillah", "Megillah", "Megillah", "מגילה", 2, 20))
    print("=== TANYA ===")
    masechtos.append(build_tanya(25))
    print("=== CHUMASH ===")
    masechtos.append(build_chumash_sefer("chumash-bereishis", "Genesis", "Bereishis", "בראשית", 50))
    masechtos.append(build_chumash_sefer("chumash-shemos", "Exodus", "Shemos", "שמות", 40))
    masechtos.append(build_chumash_sefer("chumash-vayikra", "Leviticus", "Vayikra", "ויקרא", 27))
    masechtos.append(build_chumash_sefer("chumash-bamidbar", "Numbers", "Bamidbar", "במדבר", 36))
    masechtos.append(build_chumash_sefer("chumash-devarim", "Deuteronomy", "Devarim", "דברים", 34))
    print("=== MISHNAYOS ===")
    ...
    masechtos.append(build_mishnah_masechta("mishnah-shabbat", "Mishnah Shabbat", "Mishnah Shabbos", "משנה שבת", 24))
    ...
    masechtos.append(build_mishnah_masechta("mishnah-pesachim", "Mishnah Pesachim", "Mishnah Pesachim", "משנה פּסחים", 10))
    masechtos.append(build_mishnah_masechta("mishnah-rosh-hashanah", "Mishnah Rosh Hashanah", "Mishnah Rosh Hashanah", "משנה ראש השנה", 4))
    masechtos.append(build_mishnah_masechta("mishnah-taanit", "Mishnah Taanit", "Mishnah Taanis", "משנה תענית", 4))
